...
Write-Host "=========================================="
Write-Host " HULI 4 - VALIDACAO DA FASE 4 STAGING"
Write-Host "=========================================="
...
try {
    ...
    Write-Host "[5/7] Regressao da Fase 1 e memoria..."
    & $python tools/validate_phase1.py
    & $python tools/validate_phase2.py

    Write-Host "[6/7] Knowledge Graph staging..."
    & $python tools/validate_phase3_staging.py

    Write-Host "[7/7] Personalidade e conversacao..."
    & $python tools/validate_phase4.py

    Write-Host ""
    Write-Host "=========================================="
    Write-Host " FASE 4 STAGING APROVADA NESTE COMPUTADOR"
    Write-Host "=========================================="
}
finally {
    Pop-Location
